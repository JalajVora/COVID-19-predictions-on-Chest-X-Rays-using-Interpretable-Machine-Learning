...
resized <- image_scale(covid.neg, "256x256")
print(resized)
```
<center> 
...
```{r data-explorer, echo=FALSE, warning=FALSE, message=FALSE}
...
pie(mytable, labels =  piepercent, col=rainbow(length(lbls)), main = "Pie Chart for number of positives and negatives")
```
