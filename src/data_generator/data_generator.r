...
setwd('C:\\Users\\jalaj\\Documents\\DataSci with R\\Project Files\\covid-dataset')
...
files <- list.files("C:\\Users\\jalaj\\Documents\\DataSci with R\\Project Files\\covid-dataset", recursive = TRUE, full.names = TRUE, pattern = "*.*")
...
save(covid_data, file= "covid_data_new_masked")
