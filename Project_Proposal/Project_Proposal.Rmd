...
From the motivation to help flattening the curve of COVID-19, we aim to build classifiers which achieves a base Accuracy, F~1~-Score and AUC of 85% using X-Rays. Although, research [@Zhao2020COVIDCTDatasetAC; @DeepCOVIDExplainer] extensively works with Neural Networks to classify, we intend to work classifiers which are intrinsicaly explainable. With this experiments we would try to come up with set of features that would be responsible for the diagonistic process by Classifier as well as with an explaination of why such a set of features were significant in doing so.
...
World Health Organization (WHO). WHO Statement regarding cluster of pneumonia cases in Wuhan, China
2020 [14 Januray 2020]. Available from: <https://www.who.int/china/news/detail/09-01-2020-who-statementregarding-cluster-of-pneumonia-cases-in-wuhan-china>


World Health Organization (WHO). Novel Coronavirus – China 2020 [14 January 2020]. Available from:
