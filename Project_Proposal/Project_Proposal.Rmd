...
* **Pre-Processing**
  ...
  - Our data contains 313 positive COVID-19 CXR images and 1000 negative COVID-19 CXR images. For this class imbalance problem, we would be using data resampling techniques. Currently, we are exploring the R package 'imbalance' for this problem. 
...
> **2 Meetings per week. Tuesday and Friday at 17:30 Sharp via [Zoom](https://ovgu.zoom.us/j/8905371732?pwd=b2ExRjZFazRON3VGK2s0cjgvWXVYZz09). Every Friday, Weekly Achievements would be discussed.**

```{r echo = FALSE, results='asis'}

dt <- data.frame(Week = c(rep("1", 3), 
                          rep("2", 5), 
                          rep("3", 5), 
                          rep("4", 5), 
                          rep("5", 5), 
                 ...
                 Date = c(rep("22.05.2020 - 28.05.2020", 3), 
                          ...
                          rep("05.06.2020 - 11.06.2020", 5), 
                          rep("12.06.2020 - 18.06.2020", 5), 
                          rep("19.06.2020 - 25.06.2020", 5), 
                          rep("26.06.2020 - 02.07.2020", 5), 
                          rep("03.07.2020 - 09.07.2020", 4)),
                 
                 Deadline = c(rep("28.05.2020 -- 23:59", 3), 
                              rep("04.06.2020 -- 23:59", 5), 
                              rep("11.06.2020 -- 23:59", 5), 
                              rep("18.06.2020 -- 23:59", 5), 
                              rep("25.06.2020 -- 23:59", 5), 
                 ...
                 Task_Assigned = c("Data Acquisition and Data Pre-Processing Literature Reivew", 
                                   ...
                                   "Experimenting with Bayesian Algorithms on Data", 1:20,
...
library(kableExtra)
kable(dt, align = "c") %>%
  kable_styling("bordered", latex_options = "hold_position" , full_width = F, position = "center") %>%
  column_spec(1, bold = T) %>% 
  collapse_rows(columns = 1:4,6 , valign = "middle", latex_hline = "full")
